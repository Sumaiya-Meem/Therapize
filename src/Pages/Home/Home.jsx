...
const Home = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const therapistResponse = await axios.get("../../../public/therapist.json");
      setTherapist(therapistResponse.data);
      setsearchedTherapists(therapistResponse.data);

      const testimonialResponse = await axios.get("../../../public/testimonial.json");
      setTestimonial(testimonialResponse.data);
      setsearchedTestimonials(testimonialResponse.data);

      const cityResponse = await axios.get("../../../public/city.json");
